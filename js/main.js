/**
 * Creates an array
 * Creates each object in the array, with the infos.
 * For this exercise, i don't use a DB. Full JS
 */
const thumbnailsArray = [
        new Thumbnail('Morbi ut perspiciatis','Mme Pérera', '8 juillet 2019', 'documentaliste','https://picsum.photos/200?random=1'),
        new Thumbnail('Neque porro quisquam','M. Patini', '10 juin 2019', 'professeur de français','https://picsum.photos/200?random=2'),
        new Thumbnail('At vero eos et accusamus','Mme Sabatini', '26 avril 2019', '','https://picsum.photos/200?random=3'),
        new Thumbnail('At harum quidem','M. Magionfreddo', '5 mai 2019', 'professeur d\'anglais','https://picsum.photos/200?random=4'),
        new Thumbnail('Aliquam vero eos','Mme Nefes', '31 mars 2019', 'documentaliste','https://picsum.photos/200?random=5'),
        new Thumbnail('Harum quidem','Mme Bounzy', '14 janvier 2019', '','https://picsum.photos/200?random=6')
];
